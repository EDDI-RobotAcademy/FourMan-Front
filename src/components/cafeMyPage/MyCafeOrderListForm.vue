                              ...
                              <tr>
                                 <td width="200">
                                    ...
                                    <div class="mt-3 d-flex align-center justify-center">
                                       <v-icon class="mr-2"  style="font-size: 21px;">mdi-account</v-icon>
                                       <span class="d-block" style="font-size: 16px; font-weight: bold;">
                                          {{ orderInfo.customer }}
                                       </span>
                                    </div>
                                 </td>
                                 ...
                                 <td width="200">
                                    <div>
                                       ...
                                       <div class="d-flex align-center justify-center mt-2">
                                          <v-icon class="mr-2"  style="font-size: 21px;">mdi-phone</v-icon>
                                          <span class="d-block" style="font-size: 16px; font-weight: bold;">
...
export default {
   ...
   computed: {
      reverseData() {
         return this.cafeOrderInformations.slice().reverse()
      },
      startOffset() {
