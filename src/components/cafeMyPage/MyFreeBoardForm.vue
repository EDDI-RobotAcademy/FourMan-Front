          ...
          <div id="board-list">
              <div class="container">
                  <table class="board-table">
                      ...
                      <tbody>
                      <tr v-for="(myFreeBoards, index) in calData" :key="index">
                          <td>{{ myFreeBoards.boardId }}</td>
                          <th>
                            <router-link
                                :to="{
                                    name: 'FreeBoardReadPage',
                                    params: { boardId: myFreeBoards.boardId.toString() },
                                }"
                                >{{ myFreeBoards.title}}</router-link>
                          </th>
                          <td>{{ myFreeBoards.writer }}</td>
                          <td>{{ myFreeBoards.regDate.slice(0, 10) }}</td>
                      </tr>
                      </tbody>
                  </table>
...
import router from "@/router"
  ...
  export default {
      ...
      computed: {
            ...
            calData() {
                return this.myFreeBoards.slice(this.startOffset, this.endOffset);
            },
        },
    }
