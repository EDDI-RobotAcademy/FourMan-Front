          ...
          <div id="board-list">
              <div class="container">
                  <table class="board-table">
                      ...
                      <tbody>
                      <tr v-for="(myQuestionBoards, index) in calData" :key="index">
                          <td>{{ myQuestionBoards.boardId }}</td>
                          <th>
                            <router-link
                                :to="{
                          ...
                          <td>{{ myQuestionBoards.writer }}</td>
                          <td>{{ myQuestionBoards.regDate.slice(0, 10) }}</td>
                      </tr>
                      </tbody>
                  </table>
