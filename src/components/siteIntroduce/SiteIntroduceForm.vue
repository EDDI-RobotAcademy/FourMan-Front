<template>
  <div class="NanumGothic mt-16">
    ...
    <div class="NanumGothic text-center mb-6" style="font-size: 17px">
      ...
      사람이 앉아 있으면 자리를 잡지 못하고 헛걸음을 하게 되는 일이 생기게
      됩니다.<br />
      저희는 그래서 이러한 문제점을 해결해보고자 카페를 이용하고자 하는 시간과,
      좌석, 주문까지 할 수 있는 웹사이트를 만들어보고자 하였습니다.
    </div>
    <div class="mb-10">
      <img
    ...
    >
      ...
      <div style="width: 70%">
        <v-divider class="mt-1 mb-3" style="border-top: 2px solid #808080" />
        <div style="display: flex">
          <div style="width: 25%; font-size: 16px; font-weight: bold">
            FRONT
          </div>
          <div>Vue, Vuetify, Visual Studio Code</div>
        </div>
        <v-divider class="mt-3 mb-3" />
        <div style="display: flex">
          <div style="width: 25%; font-size: 16px; font-weight: bold">BACK</div>
          <div>Spring Boot, MySQL, JPA, IntelliJ</div>
        </div>
        <v-divider class="mt-3 mb-3" />
        <div style="display: flex">
          <div style="width: 25%; font-size: 16px; font-weight: bold">ETC</div>
          <div>Slack, GitHub, Docker, Redis, Notion</div>
        </div>
    ...
    >
      ...
      <div style="width: 70%">
        ...
        <div style="display: flex">
          <div
            class="test"
            style="width: 25%; font-size: 16px; font-weight: bold"
          >
            매출액
          </div>
          <div>8조 2,201억 원 (2023년)</div>
        </div>
        <v-divider class="mt-3 mb-3" />
        <div style="display: flex">
          <div style="width: 25%; font-size: 16px; font-weight: bold">
